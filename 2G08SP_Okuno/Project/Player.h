...
private:
	...
	SpriteAnimationCreate pl_anim[ANIM_COUNT * MARIO_COUNT] = {
		...
		{"ダッシュ", 0, 32, 32, 32, TRUE, {{5, 0, 0},{5, 1, 0},{5, 2, 0},{5, 3, 0}}},
		{"ジャンプ", 0, 64, 32, 32, TRUE, {5, 0, 0}},
		{"アクションなし", 0, 0, 32, 32, FALSE, {5, 0, 0}},
		{"泳ぐ", 0, 96, 32, 32, TRUE, {{5, 0, 0},{5, 1, 0},{5, 2, 0},{5, 3, 0},{5, 4, 0}}},
		{"スーパーマリオ待機", 0, 128, 32, 64, TRUE, {5, 0, 0}},
		{"スーパーマリオダッシュ", 0, 192, 32, 64, TRUE, {{5, 0, 0},{5, 1, 0},{5, 2, 0},{5, 3, 0}}},
		{"スーパーマリオジャンプ", 0, 256, 32, 64, TRUE, {5, 0, 0}},
		{"スーパーマリオアクションなし", 0, 128, 32, 64, FALSE, {5, 0, 0}},
		{"スーパーマリオ泳ぐ", 0, 320, 32, 64, TRUE, {{5, 0, 0},{5, 1, 0},{5, 2, 0},{5, 3, 0},{5, 4, 0},{5, 5, 0}}},
		{"ファイアーマリオ待機", 0, 384, 32, 64, TRUE, {5, 0, 0}},
		{"ファイアーマリオダッシュ", 0, 448, 32, 64, TRUE, {{5, 0, 0},{5, 1, 0},{5, 2, 0},{5, 3, 0}}},
		{"ファイアーマリオジャンプ", 0, 512, 32, 64, TRUE, {5, 0, 0}},
		{"ファイアーマリオファイアーボール", 0, 576, 32, 64, FALSE, {10, 0, 0}},
		{"ファイアーマリオ泳ぐ", 0, 640, 32, 64, TRUE, {{5, 0, 0},{5, 1, 0},{5, 2, 0},{5, 3, 0},{5, 4, 0},{5, 5, 0}}},
	};
...
public:
	...
	bool IsJumpingUp() { return (m_JumpStatus == Jumping || m_JumpStatus == Swimming) && m_Move.y < 0; };
