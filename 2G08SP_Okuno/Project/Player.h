...
private:
	...
	SpriteAnimationCreate pl_anim[ANIM_COUNT * MARIO_COUNT] = {
		...
		{"スーパーマリオダッシュ", 0, 160, 32, 64, TRUE, {{5, 0, 0},{5, 1, 0},{5, 2, 0},{5, 3, 0}}},
		{"スーパーマリオジャンプ", 0, 224, 32, 64, TRUE, {5, 0, 0}},
		{"スーパーマリオアクションなし", 0, 96, 32, 64, FALSE, {5, 0, 0}},
		{"ファイアーマリオ待機", 0, 288, 32, 64, TRUE, {5, 0, 0}},
		{"ファイアーマリオダッシュ", 0, 352, 32, 64, TRUE, {{5, 0, 0},{5, 1, 0},{5, 2, 0},{5, 3, 0}}},
		{"ファイアーマリオジャンプ", 0, 416, 32, 64, TRUE, {5, 0, 0}},
		{"ファイアーマリオファイアーボール", 0, 480, 32, 64, FALSE, {10, 0, 0}},
	};
