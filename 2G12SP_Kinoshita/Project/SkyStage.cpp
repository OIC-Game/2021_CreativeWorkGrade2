...
bool CSkyStage::Load(char* pName)
{
	//テキストファイルを開く
...
void CSkyStage::Initialize()
{
}

void CSkyStage::Update(CPlayer& pl)
{
	//プレイヤーの矩形取得
...
bool CSkyStage::Collision(CRectangle r, float& ox, float& oy)
{
	bool re = false;
...
void CSkyStage::RenderDebug(void)
{
}

void CSkyStage::Release(void)
{
